...
{
    TgUINT_E32 TgALIGN(16)                      m_uiFourCC_Tool; /**< Character Code (TGSF) for the platform */
...
{
    TgUINT_E32 TgALIGN(16)                      m_uiFourCC_Data; /**< Descriptor of the file section */
...
{
    TgUINT_E32 TgALIGN(16)                      m_uiTest;
...
TgEXTN TgRESULT                             tgCM_Path_Add_Separator( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1 );
                                            ...
                                            /** @brief Add a file extension to the path (including a file extension separator)
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Add_Extension( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, TgCHAR_MB_CPC ARG2, TgRSIZE_C ARG3 );
                                            ...
                                            /** @brief Copy the path in ARG2 to OUT0
                                                ...
                                                @param[in] ARG3 Maximum capacity of the path in ARG2 
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Copy( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, TgCHAR_MB_CPC ARG2, TgRSIZE_C ARG3 );
                                            ...
                                            /** @brief Append the path in ARG2 to OUT0
                                                ...
                                                @param[in] ARG3 Maximum capacity of the path in ARG2 
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Append( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, TgCHAR_MB_CPC ARG2, TgRSIZE_C ARG3 );
...
TgEXTN TgRSIZE                              tgCM_Path_Common_Prefix_Size_U08( TgCHAR_MB_CP ARG0, TgRSIZE ARG1, TgCHAR_MB_CP ARG2, TgRSIZE ARG3 );
...
TgEXTN TgRSIZE                              tgCM_Path_Common_Prefix_Size_Count( TgCHAR_MB_CP ARG0, TgRSIZE ARG1, TgCHAR_MB_CP ARG2, TgRSIZE ARG3 );
                                            ...
                                            /** @brief Write out to the destination at OUT0 the shared path location between the two arguments
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Common_Prefix( TgCHAR_MB_P OUT0, TgRSIZE ARG1, TgCHAR_MB_CP ARG2, TgRSIZE ARG3, TgCHAR_MB_CP ARG4, TgRSIZE ARG5 );
                                            ...
                                            /** @brief Remove a trailing path separator from the path if it exists
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Remove_Separator( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1 );

                                            /** @brief Remove the first (right most) file extension, if one exists
                                                @param[in,out] OUT0 The string to be processed
                                                @param[in] ARG1 Maximum capacity of the string in OUT0
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Remove_Extension( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1 );
                                            ...
                                            /** @brief Remove the file name from the path.Anything to the right of the right most path separator is considered to be a file name
                                                ...
                                                @param[in] ARG1 Maximum capacity of the string in OUT0
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Remove_File_Name( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1 );

                                            /** @brief Rename the right most file extension, if one exists
                                                @param[in,out] OUT0 The string to be processed
                                                @param[in] ARG1 Maximum capacity of the string in OUT0
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Rename_Extension( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, TgCHAR_MB_CPC ARG2, TgRSIZE_C ARG3 );

                                            /** @brief Remove all non-filename path information. This is everything to the left of the right most path separator, inclusive.
                                                @param[in,out] OUT0 The string to be processed
                                                @param[in] ARG1 Maximum capacity of the string in OUT0
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Remove_Directory( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1 );
                                            ...
                                            /** @brief Initialize a new path from a list of path fragments
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Init( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, ... );
                                            ...
                                            /** @brief Find the first (right most) file extension in the path
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Find_Extension( TgRSIZE_P OUT0, TgCHAR_MB_CPC ARG1, TgRSIZE_C ARG2 );
                                            ...
                                            /** @brief Find the start of a file name, considered to be the first character after the right most path separator
                                                ...
                                                @param[in] ARG2 Maximum capacity of the string in ARG1
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_Path_Find_File_Name( TgRSIZE_P OUT0, TgCHAR_MB_CPC ARG1, TgRSIZE_C ARG2 );
...
TgEXTN TgBOOL                               tgCM_Path_IsAbsolute( TgCHAR_MB_CPC ARG0, TgRSIZE_C ARG1 );
...
TgEXTN TgVOID                               tgCM_File_Output_Header( STg2_Output_P OUT0, STg2_File_Block_CPC ARG1 );

                                            /** @brief Output a text representation of all the data headers
                                                @param[out] OUT0 Output object used by the function
                                                @param[in] ARG1 File block object that is processed */
TgEXTN TgVOID                               tgCM_File_Output_Data_Headers( STg2_Output_P OUT0, STg2_File_Block_CPC ARG1 );
                                            ...
                                            /** @brief Output the location of the data block at index ARG2
                                                ...
                                                @return True on success and false otherwise */
TgEXTN TgBOOL                               tgCM_File_Query_Data( TgVOID_CPP OUT0, STg2_File_Block_CPC ARG1, TgUINT_F32_C ARG2 );
                                            ...
                                            /** @brief Output the size of the data block at index ARG2
                                                ...
                                                @param[in] ARG2 Data block index
                                                @return True on success and false otherwise */
TgEXTN TgBOOL                               tgCM_File_Query_Data_Size( TgRSIZE_P OUT0, STg2_File_Block_CPC ARG1, TgUINT_F32_C ARG2 );
...
TgEXTN TgRSIZE                              tgCM_File_Query_Data_Count( STg2_File_Block_CPC ARG );

                                            /** @brief Perform a validity check on the file block
                                                @param[in] ARG File block object that is processed
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgEXTN TgRESULT                             tgCM_File_Check_Block( STg2_File_Block_CPCU ARG );
