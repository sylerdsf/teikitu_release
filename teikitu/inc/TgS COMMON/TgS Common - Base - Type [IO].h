...
TgTYPE_STRUCT(STg2_Input,)
{
    ...
    TgCHAR_MB_CP                                m_pszName; /**< Used in non-final builds to describe | identify the location of the input */
/*# !defined(TGS_FINAL) */
#endif
};
...
TgTYPE_STRUCT(STg2_Output,)
{
    ...
    TgRSIZE                                     (*m_pfnWrite)( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgVOID_CP ARG2, TgRSIZE_C ARG3 );
                                                ...
                                                /** @brief Function variable that is used to mark the object as being closed (subsequent commands will fail)
                                                    ...
                                                    @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
    TgRESULT                                    (*m_pfnClose)( STg2_Output_PC );
};
...
/* ---- STg2_Input_MEM ----------------------------------------------------------------------------------------------------------------------------------------------------------- */
                                            ...
                                            /** @brief Initializes the input memory object at ARG0 with the parameters in ARG1 - ARG3
                                                ...
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgINLINE TgRESULT                           tgIO_IM__Open( STg2_Input_MEM_PC OUT0, TgVOID_CP ARG1, TgRSIZE_C ARG2, TgFCN_MEM_RO_FREE ARG3 );
...
TgINLINE TgRSIZE                            tgIO_IM__Size( STg2_Input_MEM_PC ARG );
                                            ...
                                            /** @brief Read from the input object at ARG0 and store the data at ARG2
                                                ...
                                                @param[in] ARG4 Number of bytes to read
                                                @return The number of characters read or zero otherwise */
TgINLINE TgRSIZE                            tgIO_IM__Read( TgVOID_P OUT0, TgRSIZE_C ARG1, STg2_Input_PC ARG2, TgRSIZE_C ARG3, TgRSIZE_C ARG4 );
                                            ...
                                            /** @brief Tests to see if the input object has been completely read
                                                ...
                                                @return True if the at the end of input, and false otherwise */
TgINLINE TgBOOL                             tgIO_IM__End_Of_File( STg2_Input_PC ARG0, TgRSIZE_C ARG1 );
...
/* ---- STg2_Output_MEM ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
                                            ...
                                            /** @brief Initializes the output memory object at ARG0 with the parameters in ARG1 - ARG3
                                                ...
                                                @param[in] ARG3 Function used (if not NULL) to free the memory region on close
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgINLINE TgRESULT                           tgIO_OM__Open( STg2_Output_MEM_PC OUT0, TgVOID_P ARG1, TgRSIZE_C ARG2, TgFCN_MEM_RW_FREE ARG3 );

                                            /** @brief Mark the object as being closed (subsequent commands will fail), and optionally frees the memory region
                                                @param[in,out] ARG Pointer to an output object that is memory backed
                                                @return KTgS_OK on success and KTgE_FAIL (or other failure error code) otherwise */
TgINLINE TgRESULT                           tgIO_OM__Close( STg2_Output_PC ARG );
...
TgINLINE TgUINT_F08_CP                      tgIO_OM__Query_Data( STg2_Output_MEM_PC ARG );
                                            ...
                                            /** @brief Write the data stream in ARG2 out through object at ARG0
                                                ...
                                                @param[in] ARG3 Size to be written
                                                @return The number of characters written or zero otherwise */
TgINLINE TgRSIZE                            tgIO_OM__Write( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgVOID_CP ARG2, TgRSIZE_C ARG3 );
...
TgEXTN TgRSIZE                              tgIO_Read_Line_NCZ( TgCHAR_NC_PC OUT0, TgRSIZE_C ARG1, STg2_Input_PC ARG2, TgRSIZE_C ARG3 );
                                            ...
                                            /** @brief Read input (terminating on a new line character) from object at ARG2 into the stream at ARG0
                                                ...
                                                @param[in] ARG3 Offset into the input object to start reading
                                                @return The number of bytes written to the memory at ARG0 or zero otherwise */
TgEXTN TgRSIZE                              tgIO_Read_Line_WCZ( TgCHAR_WC_PC OUT0, TgRSIZE_C ARG1, STg2_Input_PC ARG2, TgRSIZE_C ARG3 );
                                            ...
                                            /** @brief Read input (terminating on a new line character) from object at ARG2 into the stream at ARG0
                                                ...
                                                @param[in] ARG3 Offset into the input object to start reading
                                                @return The number of bytes written to the memory at ARG0 or zero otherwise */
TgEXTN TgRSIZE                              tgIO_Read_Line( TgCHAR_MB_PC OUT0, TgRSIZE_C ARG1, STg2_Input_PC ARG2, TgRSIZE_C ARG3 );
...
/* ---- Text Output -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0
                                                ...
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_Print_NCZ( STg2_Output_PC ARG0, TgCHAR_NC_CPC ARG1, TgRSIZE_C ARG2 );
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0
                                                ...
                                                @param[in] ARG2 Maximum number of \b >bytes< in the buffer at ARG1
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_Print_WCZ( STg2_Output_PC ARG0, TgCHAR_WC_CPC ARG1, TgRSIZE_C ARG2 );
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0
                                                ...
                                                @param[in] ARG2 Maximum number of \b >bytes< in the buffer at ARG1
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_Print( STg2_Output_PC ARG0, TgCHAR_MB_CPC ARG1, TgRSIZE_C ARG2 );
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0 using printf replacement semantics
                                                ...
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_PrintF_NCZ( STg2_Output_PC ARG0, TgCHAR_NC_CPC ARG1, ... );
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0 using printf replacement semantics
                                                ...
                                                @param[in] ... variable number of arguments for printf literal at ARG1
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_PrintF_WCZ( STg2_Output_PC ARG0, TgCHAR_WC_CPC ARG1, ... );
                                            ...
                                            /** @brief Write the null-terminate contents at ARG1 out through object at ARG0 using printf replacement semantics
                                                ...
                                                @param[in] ... variable number of arguments for printf literal at ARG1
                                                @return The number of characters written or zero otherwise */
TgEXTN TgRSIZE                              tgIO_PrintF( STg2_Output_PC ARG0, TgCHAR_MB_CPC ARG1, ... );
...
TgEXTN TgRSIZE                              tgPM_DBG_ERR_Write_Byte( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgUINT_F08_C ARG2 );

                                            /** @brief Default output function used to signal an error (breakpoint) */
TgEXTN TgRSIZE                              tgPM_DBG_ERR_Write( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgVOID_CP ARG2, TgRSIZE_C ARG3 );

                                            /** @brief Default output function used to write the standard out */
TgEXTN TgRSIZE                              tgPM_DBG_OUT_Write_Byte( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgUINT_F08_C ARG2 );

                                            /** @brief Default output function used to write the standard out */
TgEXTN TgRSIZE                              tgPM_DBG_OUT_Write( STg2_Output_PC ARG0, TgRSIZE_C ARG1, TgVOID_CP ARG2, TgRSIZE_C ARG3 );
