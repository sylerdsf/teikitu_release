...
TgINLINE TgVOID tgCM_UT_ST__ST__SZ_Assign( STg2_UT_ST__ST_PC psDest, TgCHAR_MB_CPC mbzARG )
{
    ...
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzARG, KTgMAX_RSIZE );
...
TgINLINE TgVOID tgCM_UT_ST__ST__SN_Assign( STg2_UT_ST__ST_PC psDest, TgCHAR_MB_CPC mbzARG, TgRSIZE_C nbyMaxARG )
{
    ...
    TgPARAM_CHECK((nullptr != psDest) && (nullptr != mbzARG));
    sSrc.m_mbzSrc = mbzARG;
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzARG, nbyMaxARG );
    sSrc.m_nbyReserve = KTgMAX_RSIZE;
...
TgINLINE TgVOID tgCM_UT_ST__ST__PT_Assign( STg2_UT_ST__ST_PC psDest, TgCHAR_MB_CPC mbzStart, TgCHAR_MB_CPC mbzEnd )
{
    ...
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzStart, (TgRSIZE)(mbzEnd - mbzStart) );
    sSrc.m_nbyReserve = KTgMAX_RSIZE;
...
TgINLINE TgRESULT tgCM_UT_ST__ST__ST_SZ_Compare( TgSINT_F08_P piCMP, STg2_UT_ST__ST_CPC psARG0, TgCHAR_MB_CPC mbzARG1 )
{
    ...
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzARG1, KTgMAX_RSIZE );
    sSrc.m_nbyReserve = KTgMAX_RSIZE;
...
TgINLINE TgRESULT tgCM_UT_ST__ST__ST_SN_Compare( TgSINT_F08_P piCMP, STg2_UT_ST__ST_CPC psARG0, TgCHAR_MB_CPC mbzARG1, TgRSIZE_C nbyARG1 )
{
    ...
    sSrc.m_mbzSrc = mbzARG1;
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzARG1, nbyARG1 );
    sSrc.m_nbyReserve = KTgMAX_RSIZE;
    ...
    TgSINT_F08_P piCMP, STg2_UT_ST__ST_CPC psARG0, TgRSIZE_C uiOffset_ARG0, TgRSIZE_C uiMaxRead, TgCHAR_MB_CPC mbzARG1, TgRSIZE_C nbyARG )
{
    ...
    sSrc.m_mbzSrc = mbzARG1;
    sSrc.m_nbyBuffer = tgMBZ_Length_U08( mbzARG1, nbyARG );
    sSrc.m_nbyReserve = KTgMAX_RSIZE;
    ...
    TgSINT_F08_P piCMP, STg2_UT_ST__ST_CPC psARG0, TgRSIZE_C uiOffset_ARG0, TgRSIZE_C uiMaxRead, STg2_UT_ST__ST_CPC psARG1, TgRSIZE_C uiOffset_ARG1 )
{
    ...
    return (tgMBZ_CompareN( piCMP, mbzARG0, psARG0->m_nbyBuffer, uiOffset_ARG0, mbzARG1, psARG1->m_nbyBuffer, uiOffset_ARG1, uiMaxRead ));
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT tgCM_UT_ST__ST__SO_SN_Find_Set( STg1_Text_Length_PC psOffset, STg2_UT_ST__ST_CPC psARG_0, TgRSIZE_C uiARG_0_Offset, TgCHAR_MB_CPC mbzARG_1, TgRSIZE_C nbyARG_1 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT tgCM_UT_ST__ST__SO_SN_RFind_Set( STg1_Text_Length_PC psOffset, STg2_UT_ST__ST_CPC psARG_0, TgRSIZE_C uiARG_0_Offset, TgCHAR_MB_CPC mbzARG_1, TgRSIZE_C nbyARG_1 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT tgCM_UT_ST__ST__SO_SN_RFind_Not_Set( STg1_Text_Length_PC psOffset, STg2_UT_ST__ST_CPC psARG0, TgRSIZE_C uiOffset_ARG0, TgCHAR_MB_CPC mbzARG1, TgRSIZE_C nbyARG1 )
{
