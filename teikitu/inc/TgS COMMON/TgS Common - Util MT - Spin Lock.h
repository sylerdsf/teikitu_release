...
{
    STg2_UT_LF__SN TgALIGN(TgCCL)               m_sLock;
...
{
    STg2_UT_LF__SN_CNT TgALIGN(TgCCL)           m_sLock;
    TgUINT_E08                                  m_uiPad[TgCCL - (8 % TgCCL)];
};
...
TgTYPE_UNION(STg2_UT_ST__SRV_REQ_ID,)
{
    TgUINT_E128                                 m_uiSRV_REQ_ID;
    struct
    {
        union
        {
...
{
    TgUINT_E128_A                               m_uiSRV_REQ_ID;
};

TgTYPE_STRUCT(STg2_UT_LF_ISO__SN_ID,)
{
    STg2_UT_LF__SN_ID TgALIGN(TgCCL)            m_sLock;
...
/** @{ */
                                            ...
                                            /** @brief Initialize a spin lock (non reentrant), starting in a signalled state
                                                @param[out] OUT Pointer to a spin lock object
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN__Init( STg2_UT_LF__SN_PCU OUT );

                                            /** @brief Free all resources used by the object and perform some sanity checks
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN__Free_Unsafe( STg2_UT_LF__SN_PCU ARG );


                                            /** @brief Continuously attempt to acquire the lock until successful, yielding the thread between each attempt
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN__Lock_Yield( STg2_UT_LF__SN_PCU ARG );

                                            /** @brief Continuously attempt to acquire the lock until successful, pausing the thread between each attempt
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN__Lock_Spin( STg2_UT_LF__SN_PCU ARG );

                                            /** @brief Attempt to acquire the lock
                                                @param[in,out] ARG Pointer to a spin lock object
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN__Lock_Test( STg2_UT_LF__SN_PCU ARG );


                                            /** @brief Signal the semaphore
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN__Signal( STg2_UT_LF__SN_PCU ARG );
...
/** @{ */
                                            ...
                                            /** @brief Initialize a specialized semaphore object used in the kernel used to track multiple producers and a single consumer
                                                ...
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_CNT__Init( STg2_UT_LF__SN_CNT_PCU OUT );

                                            /** @brief Free all resources used by the object and perform some sanity checks
                                                @param[in,out] ARG Pointer to a spin lock counting object */
TgINLINE TgVOID                             tgCM_UT_LF__SN_CNT__Free_Unsafe( STg2_UT_LF__SN_CNT_PCU ARG );


                                            /** @brief Attempt to acquire the lock, and on failure increment an internal counter
                                                @param[in,out] ARG Pointer to a spin lock counting object
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_CNT__Lock_Or_Increment_Count( STg2_UT_LF__SN_CNT_PCU ARG );
...
TgINLINE TgUINT_F32                         tgCM_UT_LF__SN_CNT__Signal_Or_Reset_Count( STg2_UT_LF__SN_CNT_PCU ARG );
...
/** @{ */
                                            ...
                                            /** @brief Initialize a spin lock (non reentrant), starting in a signalled state with an invalid ID
                                                @param[out] OUT0 Pointer to a spin lock object
                                                @param[in] ARG1 Initial value for the lock's identifier
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Init( STg2_UT_LF__SN_ID_PCU OUT0, TgUINT_E64_C ARG1 );

                                            /** @brief Free all resources used by the object and perform some sanity checks
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN_ID__Free_Yield( STg2_UT_LF__SN_ID_PCU ARG );

                                            /** @brief Free all resources used by the object and perform some sanity checks
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN_ID__Free_Spin( STg2_UT_LF__SN_ID_PCU ARG );

                                            /** @brief Free all resources used by the object and perform some sanity checks
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN_ID__Free_Unsafe( STg2_UT_LF__SN_ID_PCU ARG );
                                            ...
                                            /** @brief Acquire the lock, spinning with a yield until complete, and fail if ARG1 at any time fails to match the lock's identifier
                                                ...
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Lock_Yield( STg2_UT_LF__SN_ID_PCU ARG0, TgUINT_E64_C ARG1 );
                                            ...
                                            /** @brief Acquire the lock, spinning with a pause until complete, and fail if ARG1 at any time fails to match the lock's identifier
                                                ...
                                                @param[in] ARG1 Additional value that will need to match the lock's identifier
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Lock_Spin( STg2_UT_LF__SN_ID_PCU ARG0, TgUINT_E64_C ARG1 );

                                            /** @brief Attempt to acquire the lock if ARG1 matches the locks identifier
                                                @param[in,out] ARG0 Pointer to a spin lock object
                                                @param[in] ARG1 Additional value that will need to match the lock's identifier
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Lock_Test( STg2_UT_LF__SN_ID_PCU ARG0, TgUINT_E64_C ARG1 );
                                            ...
                                            /** @brief Signal the semaphore, it is assumed that the identifier will not be invalidated without locking
                                                ...
                                                @param[in] ARG1 Additional value that will need to match the lock's identifier
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Invalidate_Index_Yield( STg2_UT_LF__SN_ID_PCU ARG0, TgUINT_E64_C ARG1 );

                                            /** @brief Signal the semaphore, it is assumed that the identifier will not be invalidated without locking
                                                @param[in,out] ARG0 Pointer to a spin lock object
                                                @param[in] ARG1 Additional value that will need to match the lock's identifier
                                                @return Result code, KTgS_OK on success */
TgINLINE TgRESULT                           tgCM_UT_LF__SN_ID__Invalidate_Index_Spin( STg2_UT_LF__SN_ID_PCU ARG0, TgUINT_E64_C ARG1 );

                                            /** @brief Signal the semaphore, it is assumed that the identifier will not be invalidated without locking
                                                @param[in,out] ARG Pointer to a spin lock object */
TgINLINE TgVOID                             tgCM_UT_LF__SN_ID__Signal( STg2_UT_LF__SN_ID_PCU ARG );
