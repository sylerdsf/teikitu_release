...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (X86_64) Common - Math [Matrix] [N] [F] [34].c
...
/* ---- tgMH_CAT_N_F32_04_3_IMPL ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgMH_CAT_N_F32_04_3_IMPL( TgVEC_N_F32_04_3_PCU ptmRet, TgVEC_N_F32_04_3_CPCU pxM0, TgVEC_N_F32_04_3_CPCU pxM1 )
{
...
/* ---- tgMH_INV_DET_N_F32_04_3_IMPL -------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgMH_INV_DET_N_F32_04_3_IMPL( TgVEC_N_F32_04_3_PCU ptmRet, TgVEC_N_F32_04_1_C vDet, TgVEC_N_F32_04_3_CPCU pxM1 )
{
    ...
    const __m128                        mi00 = _mm_and_ps( KTgFFF0_V128.m_N_F32_04_1, vDet );
    const __m128                        miDet = _mm_add_ps( KTgUNIT_W_V128.m_N_F32_04_1, mi00 );
    ...
    const __m128                        mi10 = _mm_and_ps( KTgFFF0_V128.m_N_F32_04_1, _mm_div_ps( mi09, miDet ) );
    ...
    const __m128                        mi20 = _mm_and_ps( KTgFFF0_V128.m_N_F32_04_1, _mm_div_ps( mi19, miDet ) );
    ...
    const __m128                        mi30 = _mm_and_ps( KTgFFF0_V128.m_N_F32_04_1, _mm_div_ps( mi29, miDet ) );
    ...
    const __m128                        mi43 = _mm_sub_ps( KTgZERO_V128.m_N_F32_04_1, mi40 );
    const __m128                        mi44 = _mm_add_ps( mi41, mi42 );
    const __m128                        mi45 = _mm_and_ps( KTgFFF0_V128.m_N_F32_04_1, _mm_sub_ps( mi43, mi44 ) );
    ...
    ptmRet->m_avRow[0] = _mm_add_ps( mi46, mi10 );
    ptmRet->m_avRow[1] = _mm_add_ps( mi47, mi20 );
    ptmRet->m_avRow[2] = _mm_add_ps( mi48, mi30 );
}


/* ---- tgMH_DET_N_F32_04_3_IMPL ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVEC_N_F32_04_1 tgMH_DET_N_F32_04_3_IMPL( TgVEC_N_F32_04_3_CPCU pxM1 )
{
    const __m128                        miR0 = pxM1->m_avRow[0];
    const __m128                        miR1 = pxM1->m_avRow[1];
    const __m128                        miR2 = pxM1->m_avRow[2];
