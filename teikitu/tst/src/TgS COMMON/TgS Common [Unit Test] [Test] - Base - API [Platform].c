...
TEST_LOCAL TgUINT_F32 Thread_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    tgTR_Yield();
...
TEST_LOCAL TgUINT_F32 Thread_Unit_Test_Gated( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
...
TEST_LOCAL TgUINT_F32 Thread_Unit_Test_Noop( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    return (0);
}


TEST_LOCAL TgUINT_F32 Thread_Unit_Test_Sleep( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    tgTR_Sleep(1000000);
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Register_Main_Thread )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Create )
{
#if TgCOMPILE__THREAD
    ...
    tiThread = tgTR_Create( Thread_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Query_Id )
{
#if TgCOMPILE__THREAD
    TgTHREAD_ID                         tiThread;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Close )
{
#if TgCOMPILE__THREAD
    TgTHREAD_ID                         tiThread;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Status )
{
#if TgCOMPILE__THREAD
    TgTHREAD_ID                         tiThread;
    ...
    tiThread = tgTR_Create( Thread_Unit_Test_Gated, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiThread.m_uiKI);
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Stack_Size )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Yield )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Pause )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__TR_Sleep )
{
#if TgCOMPILE__THREAD
    TgTHREAD_ID                         tiThread;
    TgRSIZE                             uiIndex;
    ...
    {
        tiThread = tgTR_Create( Thread_Unit_Test_Noop, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
        Test__Expect_NE(KTgID__INVALID_VALUE, tiThread.m_uiKI);
        tgTR_Close( tiThread );
    };
    ...
    for (uiIndex = 0; uiIndex < 1000; ++uiIndex)
    {
        tiThread = tgTR_Create( Thread_Unit_Test_Sleep, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
        Test__Expect_NE(KTgID__INVALID_VALUE, tiThread.m_uiKI);
        tgTR_Close( tiThread );
    };
    fEnd = tgTM_Query_Time();
