...
TEST_LOCAL TgUINT_F32                       Spin_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Suspend_Resume_Unit_Test( TgUINT_PTR_C );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_METHOD_DEFINE( UNIT_TEST__TEST__CM_UT_LF__SN__SLOW_THREAD )
{
#if TgCOMPILE__THREAD
    ...
    tiThread = tgTR_Create( Spin_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
    ...
    tiThread = tgTR_Create( Suspend_Resume_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_Unit_Test" );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__SN_ID__Init )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__SN_ID__Init( &sSN_ID, 0 ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__SN_ID__Lock_Yield )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Test( &sSN_ID, 0 ));
    tgCM_UT_LF__SN_ID__Signal( &sSN_ID );

    Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Yield( &sSN_ID, 0 ));
    Test__Expect_NE(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Test( &sSN_ID, 0 ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__SN_ID__Lock_Spin )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Spin( &sSN_ID, 0 ));
    Test__Expect_NE(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Test( &sSN_ID, 0 ));
    Test__Expect_NE(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Test( &sSN_ID, KTgID__INVALID_VALUE ));
    tgCM_UT_LF__SN_ID__Signal( &sSN_ID );
    Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__SN_ID__Lock_Test( &sSN_ID, 0 ));
...
/* ---- Spin_Unit_Test ----------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgUINT_F32 Spin_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgUINT_F32                          uiIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgUINT_F32 Suspend_Resume_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgUINT_F32                          uiIndex;
