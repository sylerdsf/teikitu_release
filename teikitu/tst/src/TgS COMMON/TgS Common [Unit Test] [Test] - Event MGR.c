...
static TgVOID EM_TE_FRM_Unit_Test( TgUINT_PTR_C );
static TgVOID EM_TE_SEC_Unit_Test( TgUINT_PTR_C );
...
/*# TgCOMPILE__THREAD */
    ...
    tiJob_Thread[0] = tgJM_Spawn_Job_Thread( atiQueueList, 4, ETgTHREAD_PRIORITY__NORMAL, "Event_MGR_Unit_Test" );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiJob_Thread[0].m_uiKI);
    tiJob_Thread[1] = tgJM_Spawn_Job_Thread( atiQueueList, 4, ETgTHREAD_PRIORITY__NORMAL, "Event_MGR_Unit_Test" );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiJob_Thread[1].m_uiKI);
    tiJob_Thread[2] = tgJM_Spawn_Job_Thread( atiQueueList, 4, ETgTHREAD_PRIORITY__NORMAL, "Event_MGR_Unit_Test" );
...
static TgVOID EM_TE_FRM_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiParam )
{
    ++s_iEvent_MGR_Test;
}

static TgVOID EM_TE_SEC_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiParam )
{
    ++s_iEvent_MGR_Test;
}
