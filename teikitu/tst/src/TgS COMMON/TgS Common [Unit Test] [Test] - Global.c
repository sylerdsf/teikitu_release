...
TEST_METHOD( UNIT_TEST__TEST__GB_CMD_Set_Command_Line )
{
    TgCHAR_MB                           szCmdLine[256];

    tgMBZ_Copy( szCmdLine, TgARRAY_COUNT( szCmdLine ), "test.exe -arg0 -arg1 parameter -arg2 \"test this as well\" -arg3", KTgMAX_RSIZE );
...
TEST_METHOD( UNIT_TEST__TEST__GB_CMD_Query_Argument_Index )
{
    ...
    tgGB_CMD_Query_Argument_Index( "test" );
...
TEST_METHOD( UNIT_TEST__TEST__GB_CMD_Push_Argument )
{
    ...
    tgMBZ_Copy( szCmdLine, TgARRAY_COUNT( szCmdLine ), "test.exe", KTgMAX_RSIZE );
    tgGB_CMD_Set_Command_Line( szCmdLine );

    tgGB_CMD_Push_Argument( "-arg0" );
    tgGB_CMD_Push_Argument( "-arg1 parameter" );
    tgGB_CMD_Push_Argument( "-arg2 \"test this as well\"" );
    tgGB_CMD_Push_Argument( "-arg3" );
    ...
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "test.exe", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(0), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg0", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(1), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg1", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(2), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "parameter", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(3), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg2", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(4), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "\"test this as well\"", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(5), KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg3", KTgMAX_RSIZE, 0, tgGB_CMD_Query_Argument(6), KTgMAX_RSIZE, 0 )) && (0 == iRet));
#if TgCOMPILE__CONSOLE
...
TEST_METHOD( UNIT_TEST__TEST__GB_Get_Unique_Name )
{
    TgCHAR_MB                           szUnique_Name_0[64], szUnique_Name_1[64];
    TgSINT_F08                          iRet;
    ...
    for (TgRSIZE uiIndex = 0; uiIndex < 1024; ++uiIndex)
    {
        ...
        Test__Expect_NE(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, szUnique_Name_0, KTgMAX_RSIZE, 0, szUnique_Name_1, KTgMAX_RSIZE, 0 )) && (0 == iRet));
    };
...
{
    TgCHAR_MB                           szCmdLine[256];
    TgCHAR_MB_CP                        aszCmd[KTgMAX_CMD_LINE_COUNT];
    TgSINT_F08                          iRet;
    ...
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "test.exe", KTgMAX_RSIZE, 0, aszCmd[0], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg0", KTgMAX_RSIZE, 0, aszCmd[1], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg1", KTgMAX_RSIZE, 0, aszCmd[2], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "parameter", KTgMAX_RSIZE, 0, aszCmd[3], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg2", KTgMAX_RSIZE, 0, aszCmd[4], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "\"test this as well\"", KTgMAX_RSIZE, 0, aszCmd[5], KTgMAX_RSIZE, 0 )) && (0 == iRet));
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "-arg3", KTgMAX_RSIZE, 0, aszCmd[6], KTgMAX_RSIZE, 0 )) && (0 == iRet));
#if TgCOMPILE__CONSOLE
    tgCN_Set_Severity_Filter( KTgCN_CHANEL_MESSAGE, KTgCN_MAX_SEVERITY );
#endif
