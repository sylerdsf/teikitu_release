...
static TgCHAR_MB                            s_mbzTest_6[] = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
static TgCHAR_MB                            s_mbzTest_5[] = "AbCdEfGhIZZjKlMnOpQrStUvWxYzZZ";
static TgCHAR_MB                            s_mbzTest_4[] = KTgMB_LIT_TEST__RUSSIAN;
static TgCHAR_MB                            s_mbzTest_3[] = "AbCdEfGhIjKlMnOpQrStUvWxYz";
static TgCHAR_MB                            s_mbzTest_2[] = KTgMB_LIT_TEST__BURMESE;
static TgCHAR_MB                            s_mbzTest_1[] = "Za4";
static TgCHAR_MB                            s_mbzTest_0[] = "~";
static TgCHAR_MB_CP                         s_ambzTest[] = { s_mbzTest_0, s_mbzTest_1, s_mbzTest_2, s_mbzTest_3, s_mbzTest_4, s_mbzTest_5, s_mbzTest_6 };
static STg1_Text_Length                     s_asTest_Length[TgARRAY_COUNT(s_ambzTest)];

static TgCHAR_MB                            s_mbzCmp_Test_1[] = "AZAA";
static TgCHAR_MB                            s_mbzCmp_Test_2[] = "BYAA";
static TgCHAR_MB                            s_mbzCmp_Test_3[] = "CXAA";
static TgCHAR_MB                            s_mbzCmp_Test_4[] = "DWAA";
static TgCHAR_MB                            s_mbzCmp_Test_5[] = "azAa";
static TgCHAR_MB                            s_mbzCmp_Test_6[] = "byAa";
static TgCHAR_MB                            s_mbzCmp_Test_7[] = "cxAa";
static TgCHAR_MB                            s_mbzCmp_Test_8[] = "dwAa";

TgCOMPILER_ASSERT(sizeof(s_mbzCmp_Test_1) < KTgSTRING_STATIC_BUFFER_SIZE, );

static TgCHAR_MB_CP                         s_ambzCmp_Test[] = { s_mbzCmp_Test_1, s_mbzCmp_Test_2, s_mbzCmp_Test_3, s_mbzCmp_Test_4,
...
TEST_METHOD_DEFINE( UNIT_TEST__TEST__UTIL_ST_String )
{
    ...
    {
        tgMBZ_Length( s_asTest_Length + uiIndex, s_ambzTest[uiIndex], KTgMAX_RSIZE );
    };
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__SZ_Init )
{
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        Test__Expect_EQ(tgKB.m_nbyBuffer, tgMBZ_Length_U08( mbzKB, nbyMaxTest ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__SN_Init )
{
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        for (TgRSIZE nbySize = 0, nbySize_Step = 0; nbySize_Step <= uiMaxStep_nbyTest; ++nbySize_Step)
        {
            ...
            Test__Expect_EQ(tgKB.m_nbyBuffer, tgCM_UT_ST__ST__Length_U08( &tgKB ));
            Test__Expect_EQ(tgKB.m_nbyBuffer, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
    ...
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        for (TgRSIZE uiTest_Start = 0, uiTest_Start_Step = 0; uiTest_Start_Step <= uiMaxStep_nuiTest; ++uiTest_Start_Step)
        {
            ...
            for (TgRSIZE uiTest_End = uiTest_Start, uiTest_End_Step = uiTest_Start_Step; uiTest_End_Step <= uiMaxStep_nuiTest; ++uiTest_End_Step)
            {
                ...
                tgCM_UT_ST__ST__SZ_Init( &tgKB, s_ambzTest[uiIndex] );
                mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
                mbzKB_Start = tgMBZ_Query_At( mbzKB, tgKB.m_nbyBuffer + 1, uiTest_Start );
                mbzKB_End = tgMBZ_Query_At( mbzKB, tgKB.m_nbyBuffer + 1, uiTest_End );
    ...
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        for (TgRSIZE uiTest_Start = 0, uiTest_Start_Step = 0; uiTest_Start_Step <= uiMaxStep_nuiTest; ++uiTest_Start_Step)
        {
            ...
            for (TgRSIZE uiTest_End = uiTest_Start, uiTest_End_Step = uiTest_Start_Step; uiTest_End_Step <= uiMaxStep_nuiTest; ++uiTest_End_Step)
            {
                ...
                Test__Expect_EQ(nbyMaxTest + nbyTest, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
                ...
                for (TgRSIZE uiIndex2 = 0; uiIndex2 < TgARRAY_COUNT(s_ambzTest); ++uiIndex2)
                {
                    ...
                    Test__Expect_EQ(nbyMaxTest2 + nbyTest, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__ST_Append )
{
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        Test__Expect_EQ(nbyMaxTest + nbyMaxTest, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
    ...
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        for (TgRSIZE uiTest_Start = 0, uiTest_Start_Step = 0; uiTest_Start_Step <= uiMaxStep_nuiTest; ++uiTest_Start_Step)
        {
            ...
            for (TgRSIZE uiInsert_Index = 0, uiInsert_Index_Step = 0; uiInsert_Index_Step <= uiMaxStep_nuiTest; ++uiInsert_Index_Step)
            {
                ...
                mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
                mbzKB_Start = tgMBZ_Query_At( mbzKB, tgKB.m_nbyBuffer + 1, uiInsert_Index );
        ...
        for (TgRSIZE uiTest_Start = 0, uiTest_Start_Step = 0; uiTest_Start_Step <= uiMaxStep_nuiTest; ++uiTest_Start_Step)
        {
            ...
            for (TgRSIZE uiTest_End = uiTest_Start, uiTest_End_Step = uiTest_Start_Step; uiTest_End_Step <= uiMaxStep_nuiTest; ++uiTest_End_Step)
            {
                ...
                for (TgRSIZE uiInsert_Index = 0, uiInsert_Index_Step = 0; uiInsert_Index_Step <= uiMaxStep_nuiTest; ++uiInsert_Index_Step)
                {
                    ...
                    tgCM_UT_ST__ST__SZ_Init( &tgKB, s_ambzTest[uiIndex] );
                    mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
                    mbzKB_Start = tgMBZ_Query_At( mbzKB, nbyMaxTest + 1, uiTest_Start );
                    mbzKB_End = tgMBZ_Query_At( mbzKB, nbyMaxTest + 1, uiTest_End );
        ...
        for (TgRSIZE uiTest_Start = 0, uiTest_Start_Step = 0; uiTest_Start_Step <= uiMaxStep_nuiTest; ++uiTest_Start_Step)
        {
            ...
            for (TgRSIZE uiDest_Start = 0, uiDest_Start_Step = 0; uiDest_Start_Step <= uiMaxStep_nuiTest; ++uiDest_Start_Step)
            {
                for (TgRSIZE uiDest_End = uiDest_Start, uiDest_End_Step = uiDest_Start_Step; uiDest_End_Step <= uiMaxStep_nuiTest; ++uiDest_End_Step)
                {
                    ...
                    mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
                    mbzKB_Start = tgMBZ_Query_At( mbzKB, tgKB.m_nbyBuffer + 1, uiDest_Start );

                    mbzDest_Start = tgMBZ_Query_At( s_ambzTest[uiIndex], nbyMaxTest + 1, uiDest_Start );
                    nbyDest_Start = (TgRSIZE)(mbzDest_Start - s_ambzTest[uiIndex]);
                    mbzDest_End = tgMBZ_Query_At( s_ambzTest[uiIndex], nbyMaxTest + 1, uiDest_End );
            ...
            for (TgRSIZE uiIndex2 = 0; uiIndex2 < TgARRAY_COUNT(s_ambzTest); ++uiIndex2)
            {
                ...
                for (TgRSIZE uiDest_Start = 0, uiDest_Start_Step = 0; uiDest_Start_Step <= uiMaxStep_nuiTest; ++uiDest_Start_Step)
                {
                    for (TgRSIZE uiDest_End = uiDest_Start, uiDest_End_Step = uiDest_Start_Step; uiDest_End_Step <= uiMaxStep_nuiTest; ++uiDest_End_Step)
                    {
                        ...
                        mbzDest_Start = tgMBZ_Query_At( s_ambzTest[uiIndex2], nbyMaxTest2 + 1, uiDest_Start );
                        nbyDest_Start = (TgRSIZE)(mbzDest_Start - s_ambzTest[uiIndex2]);
                        mbzDest_End = tgMBZ_Query_At( s_ambzTest[uiIndex2], nbyMaxTest2 + 1, uiDest_End );
            ...
            for (TgRSIZE uiTest_End = uiTest_Start, uiTest_End_Step = uiTest_Start_Step; uiTest_End_Step <= uiMaxStep_nuiTest; ++uiTest_End_Step)
            {
                ...
                for (TgRSIZE uiDest_Start = 0, uiDest_Start_Step = 0; uiDest_Start_Step <= uiMaxStep_nuiTest; ++uiDest_Start_Step)
                {
                    for (TgRSIZE uiDest_End = uiDest_Start, uiDest_End_Step = uiDest_Start_Step; uiDest_End_Step <= uiMaxStep_nuiTest; ++uiDest_End_Step)
                    {
                        ...
                        tgCM_UT_ST__ST__SZ_Init( &tgKB, s_ambzTest[uiIndex] );
                        mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
                        mbzDest_Start = tgMBZ_Query_At( mbzKB, nbyMaxTest + 1, uiTest_Start );
                        mbzDest_End = tgMBZ_Query_At( mbzKB, nbyMaxTest + 1, uiTest_End );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__Clear )
{
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        Test__Expect_EQ((TgRSIZE)0, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__To_Upper )
{
    for (TgRSIZE uiIndex = 1; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
        mbzTemp = (TgCHAR_MB_P)TgMALLOC_POOL( nbyMaxTest + 1 );
        tgMBZ_To_Upper( mbzTemp, nbyMaxTest + 1, s_ambzTest[uiIndex], nbyMaxTest + 1 );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__To_Lower )
{
    for (TgRSIZE uiIndex = 1; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        mbzKB = tgCM_UT_ST__ST__Query_String( &tgKB );
        mbzTemp = (TgCHAR_MB_P)TgMALLOC_POOL( nbyMaxTest + 1 );
        tgMBZ_To_Lower( mbzTemp, nbyMaxTest + 1, s_ambzTest[uiIndex], nbyMaxTest + 1 );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__Format )
{
    ...
    tgCM_UT_ST__ST__Format( &tgKB, "Test %d", 1 );
    Test__Expect_EQ(0, strcmp( tgCM_UT_ST__ST__Query_String( &tgKB ), "Test 1" ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__Swap )
{
    for (TgRSIZE uiIndex = 0; uiIndex < TgARRAY_COUNT(s_ambzTest); ++uiIndex)
    {
        ...
        Test__Expect_EQ(uiCheck, tgMBZ_Length_U08( mbzKB, KTgMAX_RSIZE ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__SO_SZ_Find_Set )
{
    TgCHAR_MB_C                         mbzTest_0[] = "\xe1\x80\x85\xe1\x80\x99\xe1\x80\xba\xe1\x80\xb8\xe1\x80\x9e\xe1\x80\x95\xe1\x80\xba\xe1\x80\x99\xe1\x80\xbe\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_A[] = "\xe1\x80\xba";
    TgCHAR_MB_C                         mbzTest_1[] = "AbCdEfGhIjKlMnOpQrStUvWxYz";
    TgCHAR_MB_C                         mbzTest_B[] = "dKt";
    ...
    Test__Expect_NE(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_Find_Set( &sOffset, &tgKB, 0, "" ));

    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_Find_Set( &sOffset, &tgKB, 0, "\xe1\x80\x85" ));
    Test__Expect_EQ((TgRSIZE)0, sOffset.m_nuiCharacters);

    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_Find_Set( &sOffset, &tgKB, 0, "\xe1\x80\x99" ));
    Test__Expect_EQ((TgRSIZE)1, sOffset.m_nuiCharacters);

    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_Find_Set( &sOffset, &tgKB, 1, "\xe1\x80\x99" ));
    Test__Expect_EQ((TgRSIZE)1, sOffset.m_nuiCharacters);
...
{
    TgCHAR_MB_C                         mbzTest_0[] = "\xe1\x80\x85\xe1\x80\x99\xe1\x80\xba\xe1\x80\xb8\xe1\x80\x9e\xe1\x80\x95\xe1\x80\xba\xe1\x80\x99\xe1\x80\xbe\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_A[] = "\xe1\x80\x85";
    TgCHAR_MB_C                         mbzTest_1[] = "AbCdEfGhIjKlMnOpQrStUvWxYz";
    TgCHAR_MB_C                         mbzTest_B[] = "Ab";
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_Find_Not_Set( &sOffset, &tgKB, 0, "" ));
    Test__Expect_EQ((TgRSIZE)0, sOffset.m_nuiCharacters);
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__SO_SZ_RFind_Set )
{
    ...
    tgCM_UT_ST__ST__SZ_Init( &tgKA, "" );
    Test__Expect_NE(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Set( &sOffset, &tgKA, 0, "" ));
    tgCM_UT_ST__ST__Free( &tgKA );
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Set( &sOffset, &tgKB, 0, "\xe1\x80\xaf" ));
    Test__Expect_EQ((TgRSIZE)9, sOffset.m_nuiCharacters);

    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Set( &sOffset, &tgKB, 0, "\xe1\x80\xbe" ));
    Test__Expect_EQ((TgRSIZE)8, sOffset.m_nuiCharacters);

    Test__Expect_NE(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Set( &sOffset, &tgKB, 0, "" ));
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Set( &sOffset, &tgKB, 0, "xUQ" ));
...
{
    TgCHAR_MB_C                         mbzTest_0[] = "\xe1\x80\x85\xe1\x80\x99\xe1\x80\xba\xe1\x80\xb8\xe1\x80\x9e\xe1\x80\x95\xe1\x80\xba\xe1\x80\x99\xe1\x80\xbe\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_A[] = "\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_1[] = "AbCdEfGhIjKlMnOpQrStUvWxYz";
    TgCHAR_MB_C                         mbzTest_B[] = "UQx";
    ...
    Test__Expect_NE(KTgS_OK, tgCM_UT_ST__ST__SO_SN_RFind_Set( &sOffset, &tgKB, 0, "", 0 ));
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__SO_SZ_RFind_Not_Set )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Not_Set( &sOffset, &tgKB, 0, "\xe1\x80\xbe\xe1\x80\xaf" ));
    ...
    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Not_Set( &sOffset, &tgKB, 0, "zYxW" ));
    Test__Expect_EQ((TgRSIZE)21, sOffset.m_nuiCharacters);

    Test__Expect_EQ(KTgS_OK, tgCM_UT_ST__ST__SO_SZ_RFind_Not_Set( &sOffset, &tgKB, 0, "" ));
...
{
    TgCHAR_MB_C                         mbzTest_0[] = "\xe1\x80\x85\xe1\x80\x99\xe1\x80\xba\xe1\x80\xb8\xe1\x80\x9e\xe1\x80\x95\xe1\x80\xba\xe1\x80\x99\xe1\x80\xbe\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_A[] = "\xe1\x80\xbe\xe1\x80\xaf";
    TgCHAR_MB_C                         mbzTest_1[] = "AbCdEfGhIjKlMnOpQrStUvWxYz";
    TgCHAR_MB_C                         mbzTest_B[] = "zYxW";
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_ST__ST__Trim_Start_Set )
{
    ...
    STg2_UT_ST__ST                      tgKB;
    TgCHAR_MB_CP                        mbzKB;
    TgCHAR_MB_C                         aszStart[] = { 'D', 'C', 'E' };
    TgCHAR_MB_C                         aszEnd[] = { 'D', 'E' };

    for (uiIndex2 = 0; uiIndex2 < 2 * KTgSTRING_STATIC_BUFFER_SIZE; uiIndex2 += KTgSTRING_STATIC_BUFFER_SIZE / 2)
    {
        TgCHAR_MB_P                         mbzInit_String_0;

        mbzInit_String_0 = TgMALLOC_TEMP( uiIndex2 + 1 );
        ...
        {
            TgCHAR_MB_P                         mbzInit_String_1, mbzInit_String_2;

            mbzInit_String_1 = TgMALLOC_TEMP( uiSize + 1 );
            tgMM_Set_U08(mbzInit_String_1, uiSize, (TgUINT_E08)(aszStart[0]) );
            mbzInit_String_1[uiSize] = 0;

            mbzInit_String_2 = TgMALLOC_TEMP( uiSize + 1 );
