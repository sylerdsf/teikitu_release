...
static TgVOID                               UNIT_TEST__TEST__SM_Setup_Table_Input( TgCHAR_MB_P, TgRSIZE_C, STg2_Input_MEM_P );
...
TEST_METHOD( UNIT_TEST__TEST__SM_UID_Init_String )
{
    Test__Expect_EQ(KTgSM_MAX_NATIVE_ENTRIES - 1, tgSM_UID_Init_String( "Unit Test 1", KTgSM_MAX_NATIVE_ENTRIES - 1 ));
...
TEST_METHOD( UNIT_TEST__TEST__SM_UID_Query_String )
{
    ...
    Test__Expect_EQ(KTgSM_MAX_NATIVE_ENTRIES - 2, tgSM_UID_Init_String( "Unit Test 2", KTgSM_MAX_NATIVE_ENTRIES - 2 ));
    mbzBuffer = tgSM_UID_Query_String( KTgSM_MAX_NATIVE_ENTRIES - 2 );
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 2", KTgMAX_RSIZE, 0, mbzBuffer, KTgMAX_RSIZE, 0 )) && (0 == iRet));
...
TEST_METHOD( UNIT_TEST__TEST__SM_Dict_Insert_String_Hash )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgMBZ_Hash( &uiHash, "Unit Test 3", KTgMAX_RSIZE ));
    tiString_Dict = tgSM_Dict_Insert_String_Hash( "Unit Test 3", KTgMAX_RSIZE, uiHash );
...
TEST_METHOD( UNIT_TEST__TEST__SM_Dict_Insert_String )
{
    ...
    tiString_Dict = tgSM_Dict_Insert_String( "Unit Test 4", KTgMAX_RSIZE );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiString_Dict.m_uiKI);
...
TEST_METHOD( UNIT_TEST__TEST__SM_Dict_Find_Id_By_Hash )
{
    ...
    Test__Expect_EQ(KTgS_OK, tgMBZ_Hash( &uiHash, "Unit Test 5", KTgMAX_RSIZE ));
    tiString_Dict = tgSM_Dict_Insert_String_Hash( "Unit Test 5", KTgMAX_RSIZE, uiHash );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiString_Dict.m_uiKI);
    Test__Expect_NE(tiString_Dict.m_uiKI, tgSM_Dict_Find_Id_By_Hash( "Unit Test 5", KTgEMPTY_HASH ).m_uiKI );
    Test__Expect_EQ(tiString_Dict.m_uiKI, tgSM_Dict_Find_Id_By_Hash( "Unit Test 5", uiHash ).m_uiKI );
...
TEST_METHOD( UNIT_TEST__TEST__SM_Dict_Find_Id_By_String )
{
    ...
    tiString_Dict = tgSM_Dict_Insert_String( "Unit Test 6", KTgMAX_RSIZE );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiString_Dict.m_uiKI);
    Test__Expect_EQ(tiString_Dict.m_uiKI, tgSM_Dict_Find_Id_By_String( "Unit Test 6", KTgMAX_RSIZE ).m_uiKI );
...
TEST_METHOD( UNIT_TEST__TEST__SM_Dict_Query_String )
{
    ...
    tiString_Dict = tgSM_Dict_Insert_String( "Unit Test 7", KTgMAX_RSIZE );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiString_Dict.m_uiKI);
    tiString_Dict = tgSM_Dict_Insert_String( "Unit Test 8", KTgMAX_RSIZE );
    Test__Expect_NE(KTgID__INVALID_VALUE, tiString_Dict.m_uiKI);


    mbzValue = nullptr;
    tgSM_Dict_Query_String( &mbzValue, &nbyValue, tiString_Dict );
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 8", KTgMAX_RSIZE, 0, mbzValue, nbyValue, 0 )) && (0 == iRet));
    Test__Expect_EQ(11, nbyValue);

    mbzValue = nullptr;
    tgSM_Dict_Query_String( &mbzValue, &nbyValue, tgSM_Dict_Find_Id_By_String( "Unit Test 7", KTgMAX_RSIZE ) );
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 7", KTgMAX_RSIZE, 0, mbzValue, nbyValue, 0 )) && (0 == iRet));
    Test__Expect_EQ(11, nbyValue);
...
TEST_METHOD( UNIT_TEST__TEST__SM_Table_Load )
{
    TgCHAR_MB TgALIGN(16)               mbzBuffer[128];
...
TEST_METHOD( UNIT_TEST__TEST__SM_Table_Query_String )
{
    ...
    Test__Expect_EQ(true, TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 9", KTgMAX_RSIZE, 0, mbzValue, nbyValue, 0 )) && (0 == iRet));
    Test__Expect_EQ(11, nbyValue);
    Test__Expect_EQ(true, tgSM_Table_Query_String( &mbzValue, &nbyValue, tiString_Table, 1 ));
    Test__Expect_EQ(true,  TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 10", KTgMAX_RSIZE, 0, mbzValue, nbyValue, 0 )) && (0 == iRet));
    Test__Expect_EQ(11, nbyValue);
    Test__Expect_EQ(true, tgSM_Table_Query_String( &mbzValue, &nbyValue, tiString_Table, 2 ));
    Test__Expect_EQ(true,  TgSUCCEEDED(tgMBZ_Compare( &iRet, "Unit Test 11", KTgMAX_RSIZE, 0, mbzValue, nbyValue, 0 )) && (0 == iRet));
    Test__Expect_EQ(11, nbyValue);
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID UNIT_TEST__TEST__SM_Setup_Table_Input( TgCHAR_MB_PC mbzBuffer, TgRSIZE_C nbyBuffer, STg2_Input_MEM_P psInput )
{
    ...
    *sBuffer.m_puiE64++ = sEntry_Id.m_uiEntry_Id;
    tgMM_Copy( sBuffer.m_puiE08, 12, "Unit Test 9", 12 );
    sBuffer.m_puiE08 += 12;

    sEntry_Id.m_uiAddress = 20;
    sEntry_Id.m_uiIndex = 2;
    *sBuffer.m_puiE64++ = sEntry_Id.m_uiEntry_Id;
    tgMM_Copy( sBuffer.m_puiE08, 12, "Unit Test 10", 12 );
    sBuffer.m_puiE08 += 12;

    sEntry_Id.m_uiAddress = 40;
    sEntry_Id.m_uiIndex = 1;
    *sBuffer.m_puiE64++ = sEntry_Id.m_uiEntry_Id;
    tgMM_Copy( sBuffer.m_puiE08, 12, "Unit Test 11", 12 );
    sBuffer.m_puiE08 += 12;
