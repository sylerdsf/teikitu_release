...
TEST_LOCAL TgUINT_F32                       Thread_AM_RW_Read_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_AM_RW_Write_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_AM_RW_Command_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_SN_RW_Read_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_SN_RW_Write_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_SN_RW_Command_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_RW_Read_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_RW_Write_Unit_Test( TgUINT_PTR_C );
TEST_LOCAL TgUINT_F32                       Thread_RW_Command_Unit_Test( TgUINT_PTR_C );

enum { KTgRWLOCK_NUM_COMMANDS_PER_THREAD    = 128 };
enum { KTgRWLOCK_NUM_THREADS                = 16 };
enum { KTgRWLOCK_COMMAND_SIZE               = KTgRWLOCK_NUM_THREADS*KTgRWLOCK_NUM_COMMANDS_PER_THREAD };
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_MT__RW__SLOW_THREAD )
{
    ...
    {
        s_uiCommand_List[iIndex] = tgCM_RAND_U08() % 2;
    ...
    if (tgGB_CMD_Query_Argument_Index( "-slow" ) >= 0 || TgCOMPILE__SLOW_UNIT_TEST)
    {
        Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__RW__Init( &s_sAM_RW ));
        for (iIndex = 0; iIndex < (KTgRWLOCK_NUM_THREADS >> 1); ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_AM_RW_Read_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_AM_RW_Read_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        for (; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_AM_RW_Write_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_AM_RW_Write_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        ...
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_AM_RW_Command_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_AM_RW_Command_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        tgPM_MT_SM_Signal( &s_sTest_Count, KTgRWLOCK_NUM_THREADS );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__RW_SN__SLOW_THREAD )
{
    ...
    if (tgGB_CMD_Query_Argument_Index( "-slow" ) >= 0 || TgCOMPILE__SLOW_UNIT_TEST)
    {
        ...
        for (iIndex = 0; iIndex < (KTgRWLOCK_NUM_THREADS >> 1); ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_SN_RW_Read_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_SN_RW_Read_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        for (; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_SN_RW_Write_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_SN_RW_Write_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        tgPM_MT_SM_Signal( &s_sTest_Count, KTgRWLOCK_NUM_THREADS );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        ...
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_SN_RW_Command_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_SN_RW_Command_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        tgPM_MT_SM_Signal( &s_sTest_Count, KTgRWLOCK_NUM_THREADS );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_MT__RW_MX__SLOW_THREAD )
{
    ...
    if (tgGB_CMD_Query_Argument_Index( "-slow" ) >= 0 || TgCOMPILE__SLOW_UNIT_TEST)
    {
        ...
        for (iIndex = 0; iIndex < (KTgRWLOCK_NUM_THREADS >> 1); ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_RW_Read_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_RW_Read_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        for (; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_RW_Write_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_RW_Write_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        tgPM_MT_SM_Signal( &s_sTest_Count, KTgRWLOCK_NUM_THREADS );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        ...
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
            tiThread[iIndex] = tgTR_Create( Thread_RW_Command_Unit_Test, 0, 0, ETgTHREAD_PRIORITY__NORMAL, "Thread_RW_Command_Unit_Test" );
            Test__Expect_NE(KTgID__INVALID_VALUE, tiThread[iIndex].m_uiKI);
        }
        tgPM_MT_SM_Signal( &s_sTest_Count, KTgRWLOCK_NUM_THREADS );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_AM_RW_Read_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_AM_RW_Write_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_AM_RW_Command_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
    TgSINT_F32                          niWrite;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_SN_RW_Read_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_SN_RW_Write_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_SN_RW_Command_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
    TgSINT_F32                          niWrite;
    TgSINT_F32                          niCommand;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_RW_Read_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_RW_Write_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_F32 Thread_RW_Command_Unit_Test( TgUINT_PTR_C UNUSED_PARAM uiUnused )
{
    TgSINT_F32                          iIndex;
    TgSINT_F32                          niWrite;
    TgSINT_F32                          niCommand;
